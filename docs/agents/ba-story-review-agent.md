...
7. If the story is not ready, explicitly list the open questions that must be answered by the PO/user before development begins.
...
Instead, you must raise a clarification question to the **PO / user**.
...
- Are there any missing product decisions that require PO clarification?
...
Raise questions to the PO/user when you find issues like:
